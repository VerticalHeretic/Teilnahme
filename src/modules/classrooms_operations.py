...
class ClassroomsOperations:
    ...
    def get_classrooms(self) -> List[Classroom]:
        ...
        """
        try: 
            classrooms = [Classroom(**classroom_data) for classroom_data in self.storage_handler.load()]
    ...
    def add_classroom(self, classroom: BaseClassroom) -> Classroom:
        ...
        """
        classroom = Classroom(id=self.storage_handler.generate_id(), **classroom.model_dump())
