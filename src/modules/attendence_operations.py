...
class AttendenceOperations:
    ...
    def get_attendence_records_by_classroom(self, classroom_id: int) -> List[AttendenceRecord]:
        ...
        filtered_by_classroom_attendence_records = [record for record in attendence_records if record.classroom_id == classroom_id]
        return filtered_by_classroom_attendence_records
    
    def get_attendence_records_by_student(self, student_id: int) -> List[AttendenceRecord]:
        ...
        """
        attendence_records = self.__get_all_attendence_records()
        filtered_by_student_attendence_records = [record for record in attendence_records if record.student_id == student_id]
    ...
    def get_attendence_records_by_date(self, date: datetime) -> List[AttendenceRecord]:
        ...
        """
        attendence_records = self.__get_all_attendence_records()
        filtered_by_date_attendence_records = [record for record in attendence_records if record.date == date]
    ...
    def __get_all_attendence_records(self) -> List[AttendenceRecord]:
        ...
        """
        try: 
            attendence_records = [AttendenceRecord(**attendence_record_data) for attendence_record_data in self.storage_handler.load()]
        except ValidationError as e:
            raise AttendenceDataError(f"Invalid attendence record data format: {str(e)}") from e

        return attendence_records
    
    def add_attendence_record(self, attendence_record: BaseAttendenceRecord) -> AttendenceRecord:
        ...
        """
        attendence_record = AttendenceRecord(id=self.storage_handler.generate_id(), **attendence_record.model_dump())
