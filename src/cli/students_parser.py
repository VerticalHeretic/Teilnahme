...
class StudentsParser:
    ...
    def setup_students_parsers(self, subparser):
        ...
        students_subparser = students_parser.add_subparsers(title="Students Commands", 
        ...
        students_add_parser.add_argument("--name", required=True, type=str, help="Student name")
        students_add_parser.add_argument("--surname", required=True, type=str, help="Student surname")
        students_add_parser.add_argument("--degree", required=True, type=DegreeName, help="Student degree")
        students_add_parser.add_argument("--semester", required=True, type=int, help="Student semester")
        students_add_parser.set_defaults(func=lambda args: self.handle_students_add(args))

        # Get students
        students_get_parser = students_subparser.add_parser("get", help="Get all students")
        students_get_parser.set_defaults(func=lambda args: self.handle_students_get(args))

        # Delete student
        students_delete_parser = students_subparser.add_parser("delete", help="Delete a student")
        students_delete_parser.add_argument("--id", required=True, type=int, help="Student id")
        students_delete_parser.set_defaults(func=lambda args: self.handle_students_delete(args))

        # Update student
        students_update_parser = students_subparser.add_parser("update", help="Update a student")
        students_update_parser.add_argument("--id", required=True, type=int, help="Student id")
